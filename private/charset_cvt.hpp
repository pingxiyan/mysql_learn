...
inline std::wstring gbk_to_utf16(const std::string &gbk)
{
#ifdef _MSC_VER
...
inline std::string utf16_to_gbk(const std::wstring &utf16)
{
#ifdef _MSC_VER
	const char* GBK_LOCALE_NAME = ".936";
#else
...
inline std::string utf8_to_gbk(const std::string &utf8)
{
